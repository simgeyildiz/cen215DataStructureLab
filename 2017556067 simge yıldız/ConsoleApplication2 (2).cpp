...
int main() {
	...
	printf(" Simge Yıldız  2017556067\n");
	...
	clock_t timer;
	timer = clock();
	int IdNum[] = { 2,0,1,7,5,5,6,0,6,7 };
	char Name[] = "Simge Yıldız";
	...
	int IdNum2[] = { 2,0,1,7,5,5,6,0,6,7 };
	char Name2[] = "Simge Yıldız";
	...
	int IdNum3[] = { 2,0,1,7,5,5,6,0,6,7 };
	char Name3[] = "Simge Yıldız";
	...
	int IdNum4[] = { 2,0,1,7,5,5,6,0,6,7 };
	char Name4[] = "Simge Yıldız";
